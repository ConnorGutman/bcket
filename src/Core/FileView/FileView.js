  ...
  render() {
    return (
      ...
      <div className="row returnTo">
          <a href="http://localhost:3000"><i className="material-icons">keyboard_arrow_left</i> Return</a>
        </div>
        <div className="row fileInfo">
          <div className="col-4 col-s-12 sidebar-scene">
            ...
            <div className="sidebar-file-meta darker-bg">
              <div>
                ...
                <p className="text-center"><i className="material-icons" id="UorD">{ this.props.UorD }</i>{this.props.uploadTime}</p>
              </div>
            </div>
          </div>
          <div className="col-8 col-s-12 info-scene">
